		...
		[
			{
				...
				"bitrate":64,              //64为语音呼叫
				"protocol":"0",	// 0 – H323呼叫，1-SIP呼叫
				"forcecall":"0", //是否强制呼叫，0不强呼,1强呼 默认是0
	        }
			……
		],
		//指定在哪个MCU里添加终端，
...
#### (37) 添加终端ACK

	{
		...
		[
		   {
				"mtNO" : "172.16.178.224",//邀请终端的ip或E164号//与添加终端REQ 相同
				"mttype" : "1",//终端类型，与添加终端REQ 相同
				"protocol" : "0"//sip-1;H323-0//与添加终端REQ 相同
				"mtidentify" : 
				{
					"mtid" : "1",		//MCU为终端分配的mtId
					"mcuidx" : ""
				}			
			},
			……
...
#### (39) 添加终端失败NTF

	{
		...
		"ocpconfname":"ForceTest",          //终端当前所在的会议名称，当errcode为20410（指定终端忙，可能在另一会议中）时生效
	                                        //errorcode为20410时，"ocpconfname"字段有效，当会议名不为空时，表示在另一个会议中
	}
...
#### (49) 发送短消息CMD

	{
		...
		"confE164":"051268#999997",
		"confname":"BookTest",
		"msgtype":"1",			// 0：自右至左滚动  1:翻页滚动 2:全页滚动
...
#### (120) 开始录像REQ

	{
		...
		"moid":"20300000000300000000000000000005",
		"recmode":"1"					//1=录像 2=直播 3=both
		"recid":"0",     				//录像id号，如果会议中还未开始录像，则填0
	
		//如果是录像过程中开启录像或者直播（recid > 0）:
		//vrsalias可不填
		//recmode=1,isanonymous可不填;
		//recmode=2,recname\publishmode\isrecmainvideo\isrecdstream\ismerge可不填
		"recname":"录像保存的文件名称"  		// 最大128字节
		"publishmode":"0" 				// 0-不发布  1-发布
		"isanonymous":"0"				//是否勾选免登陆观看直播,0=不支持 1=支持匿名观看
		"isrecmainvideo":"1" 				//是否录主格式码流（视频+音频）
		"isrecdstream":"1"				//是否录双流（仅双流）
		"ismerge":"1"    				//是否合并
		"vrsalias":					//录像机别名信息
...
#### (121) 开始录像ACK

	{
		...
		"moid":"20300000000300000000000000000005",
		"recmode":"1"		//1=录像 2=直播 3=both
		"recid":"1",       //当前录像的当前的recid（如果开启录像时是过程中，则是开启录像时所下的recid，如果是第一次开启录像，则是新的recid）
		"vrsalias"://录像机别名信息
		{
			"aliastype":"1"//录像机别名类型 0-初始值；1-ip；2-E164号码
							 //平台依据类型获取对应的别名信息
...
#### () 开始会控混音监控请求
	...
	{
		"type":"CM_CMU_STARTMONITORING_MIXER_REQ",
		"confE164":"051268#999997",
		"meetingID":"131313",
		"moid":"20300000000300000000000000000005",
...
#### () 开始会控混音监控请求ACK/NACK
	...
	{
		"type":"CMU_CM_STARTMONITORING_MIXER_ACK",
			//"CMU_CM_STARTMONITORING_MIXER_NACK",
		"confE164":"051268#999997",
		"meetingID":"131313",
		"moid":"20300000000300000000000000000005",
...
#### ()API监控会议vmp请求
	{
		"type":"CM_CMU_STARTMONITORING_VMP_REQ",
		"confE164":"051268#999997",
		"meetingID":"131313",
		"moid":"20300000000300000000000000000005",
...
#### ()API监控会议vmp请求ACK/NACK

	{
		"type":"CMU_CM_STARTMONITORING_VMP_ACK"
		// "CMU_CM_STARTMONITORING_VMP_NACK",
		"confE164":"051268#999997",
		"meetingID":"131313",
		"moid":"20300000000300000000000000000005",
				...
				[
					{
						...
						"sendrate":"128",      	//通道发送码率
						"mediares":"0",         //分辨率
						"mediatype":"0", //视频类型(主流协议)：H261-31,H263-34,H264-106,MP4-97,H265-108
				...
				[	//现在只有两个通道，后续可扩展
					{
						...
						"chnstatus":"0"		//通道0状态， 0-可用状态，1-已被其他终端占用，255-无效通道
					}
					{
						"chnnlidx":"1",
						"issilence":"0",	//通道1是否静音 0-否，1-是
						"volume":"0",		//通道1音量若静音则默认为0
						"chnstatus":"0"		//通道1状态， 0-可用状态，1-已被其他终端占用，255-无效通道
					}
				]
			}
			…
...
####(54) 被监控的终端无视频源通知
	...
	{
		"type":"CMU_CM_STARTMONITORINGALARM_NTF",
		"confE164":"3339998",
		"meetingID":"131313",
		"moid":"20300000000300000000000000000005",
		"errCode":"20513", // 20513表示无视频源
		"monitorsrc":
		{
			"selectsrctype":"//见4.2(1) ",
			"mtidentify":{  //见4.1 (1)  },	// selectsrctype = 1（终端）时有意义
...
#### (55) 开启监控失败通知
	...
	{
		"type":"CMU_CM_STARTMONITORINGFAIL_NTF",
		"confE164":"051268#999997",
		"meetingID":"131313",
		"moid":"20300000000300000000000000000005",
		"errCode":"21741", // 21741级联适配器不足， 20512音频终端不能做监控源
		"monitorsrc":
		{
			"selectsrctype":"//见4.2(1) ",
			"mtidentify":{  //见4.1 (1)  },	// selectsrctype = 1（终端）时有意义
