...
> 建议PMS新增一条消息，能够下发主备平台的MQ服务器地址信息及本平台的REDIS信息
...
```JSON
{
	...
	[
    	 ...
    	 redis: {moid:””,ip:””,port:””,db:””}, mq: {IP:””,PORT:””} },
	],
...
> 若主平台恢复，主平台CSS/MS/PAS不考虑仍在灾备平台开着的源平台是主平台的会议
...
主CSS->备CSS: MAU.CMMCU.Q(MAU.CMMCU.K:E164)
```
...
> PAS跨平台呼叫个人模板/预约会议/固定虚拟会议室选择主机房PAS
